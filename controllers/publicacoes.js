...
const apagar = async(req, res) => {
    const categorias = await api.apagar('publicacoes/'+ req.params.categoria,req.params.id)
...
const editarPost = async(req,res) => {
    await api.update('publicacoes/'+ req.params.categoria, req.params.id,{titulo: req.body.titulo, conteudo: req.body.conteudo})
    res.redirect('/publicacoes/categoria/'+ req.params.categoria)}
